...
export default {
  ...
  mounted() {
    this.history = JSON.parse(localStorage.getItem('qsearchHistory'));
    if (this.history == null) {
      localStorage.setItem('qsearchHistory', JSON.stringify([]));
      this.history = [];
    }
  },
  methods: {
    deleteHistory(item) {
      ...
      localStorage.setItem('qsearchHistory', JSON.stringify(this.history));
    },
